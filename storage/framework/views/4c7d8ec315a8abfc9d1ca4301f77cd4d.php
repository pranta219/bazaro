            ...
            <div class="row align-items-center">
                <div class="col-xl-3">
                    <div class="aq-header-logo">
                        <a href="<?php echo e(route('home')); ?>"><img data-width="145"
                                src="<?php echo e(asset('assets/img/logo/logo.png')); ?>" alt=""></a>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="aq-header-menu menu-height-80 aq-header-dropdown menu-black text-center">
                        <nav>
                            <ul>
                                <li class="has-dropdown"><a href="<?php echo e(route('home')); ?>">Home</a></li>
                        ...
                        <ul>
                            ...
                            <li class="aq-header-top-account">
                                <?php if(auth()->guard()->guest()): ?>
                                    <a href="<?php echo e(route('login')); ?>" title="Login / Register">
                                        <i>
...
</header><?php /**PATH C:\laragon\www\laravel-app\resources\views/components/header.blade.php ENDPATH**/ ?>