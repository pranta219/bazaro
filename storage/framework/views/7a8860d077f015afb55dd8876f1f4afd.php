<!-- Modal -->
<div class="modal fade aq-product-modal" id="producQuickViewModal" tabindex="-1" aria-labelledby="producQuickViewModal"
    aria-hidden="true">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="aq-modal-slider">
                                        <img class="w-100"
                                            src="<?php echo e(asset('assets/img/fashion-1/product/product-1/front-img-1.jpg')); ?>"
                                            alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="aq-modal-slider">
                                        <img class="w-100"
                                            src="<?php echo e(asset('assets/img/fashion-1/product/product-2/front-img-1.jpg')); ?>"
                                            alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="aq-modal-slider">
                                        <img class="w-100"
                                            src="<?php echo e(asset('assets/img/fashion-1/product/product-3/front-img-1.jpg')); ?>"
                                            alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="aq-modal-slider">
                                        <img class="w-100"
                                            src="<?php echo e(asset('assets/img/fashion-1/product/product-4/front-img-1.jpg')); ?>"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="aq-product-details-variation mb-30">
                            ...
                            <div class="aq-product-details-variation-wrap d-flex align-items-center">
                                <div class="aq-product-details-variation-item active">
                                    <img src="<?php echo e(asset('assets/img/fashion-1/product/product-1/front-img-1.jpg')); ?>"
                                        alt="">
                                </div>
                                <div class="aq-product-details-variation-item">
                                    <img src="<?php echo e(asset('assets/img/fashion-1/product/product-1/front-img-2.jpg')); ?>"
                                        alt="">
                                </div>
                                <div class="aq-product-details-variation-item">
                                    <img src="<?php echo e(asset('assets/img/fashion-1/product/product-1/front-img-3.jpg')); ?>"
                                        alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="aq-product-details-action-wrapper mb-20">
                            <div class="aq-product-details-action-item-wrapper d-sm-flex align-items-center">
                                ...
                                <div
                                    ...
                                    <button class="aq-product-details-add-to-cart-btn aq-btn-black radius-30 w-100">Add
                                        To Cart</button>
                            ...
                            <button
                                class="aq-product-details-buy-now-btn aq-btn-black btn-red-bg btn-shine-effect radius-30 w-100">Buy
                                Now</button>
                        </div>
...
<!-- Modal --><?php /**PATH C:\laragon\www\laravel-app\resources\views/components/modals.blade.php ENDPATH**/ ?>