<!-- product buy area start -->
<div class="elt-product-watch-area mb-120">
    <div class="container">
        <div class="elt-product-watch-wrap fix" data-bg-color="#EEEBE5">
            <div class="row justify-content-center">
                <div class="col-xl-7">
                    <div class="elt-product-watch-thumb text-end">
                        <img src="<?php echo e(asset('assets/img/watch/watch-1.png')); ?>" alt="">
                    </div>
                </div>
                <div class="col-xl-5">
                    <div class="aq-product-details-wrap pt-80 pb-80 pr-105">
                        ...
                        <div class="aq-product-details-variation mb-30">
                            ...
                            <div class="aq-product-details-variation-wrap d-flex align-items-center">
                                ...
                                <div class="aq-product-details-variation-item">
                                    <img src="<?php echo e(asset('assets/img/watch/watch-2.png')); ?>" alt="">
                                </div>
                                <div class="aq-product-details-variation-item">
                                    <img src="<?php echo e(asset('assets/img/watch/watch-3.png')); ?>" alt="">
                                </div>
                            </div>
                        </div>

                        <!-- product-action -->
                        <div class="aq-product-details-action-wrapper">
                            ...
                            <button
                                class="aq-product-details-buy-now-btn aq-btn-black btn-coffee-bg btn-shine-effect radius-30 w-100">Buy
                                Now</button>
                        </div>
                    </div>
                </div>
...
<!-- product buy area end --><?php /**PATH C:\laragon\www\laravel-app\resources\views/home/product-watch.blade.php ENDPATH**/ ?>