...
<div class="aq-wishlist-popup-wrap aq-wishlist-popup aq-wishlist-active">
    ...
    <div class="aq-wishlist-popup-middle">
        <div class="aq-wishlist-popup-item d-flex justify-content-between align-items-center">
            <div class="aq-wishlist-popup-thumb-wrap d-flex align-items-center">
                ...
                <div class="aq-wishlist-popup-thumb  d-flex align-items-center">
                    <img src="{{ asset('assets/img/electronics/arrival-product/product-3/product-1.jpg') }}" alt="">
                    <div class="aq-wishlist-popup-thumb-info">
                        <h4 class="aq-wishlist-popup-title">iPhone 13 Pro max</h4>
                        <span class="aq-wishlist-popup-price">578.00</span>
                    </div>
                </div>
            </div>
            <div class="aq-wishlist-popup-btn">
                <a class="aq-btn-black btn-red-bg btn-shine-effect btn-h-40" href="#">Add to bag</a>
            </div>
        </div>
        <div class="aq-wishlist-popup-item d-flex justify-content-between align-items-center">
            <div class="aq-wishlist-popup-thumb-wrap d-flex align-items-center">
                <span class="aq-wishlist-popup-remove"><i class="fa-regular fa-xmark"></i></span>
                <div class="aq-wishlist-popup-thumb  d-flex align-items-center">
                    <img src="{{ asset('assets/img/electronics/arrival-product/product-4/product-1.jpg') }}" alt="">
                    <div class="aq-wishlist-popup-thumb-info">
                        <h4 class="aq-wishlist-popup-title">iPhone 13 Pro max</h4>
                        <span class="aq-wishlist-popup-price">578.00</span>
                    </div>
        ...
        <div class="aq-wishlist-popup-item d-flex justify-content-between align-items-center">
            <div class="aq-wishlist-popup-thumb-wrap d-flex align-items-center">
                <span class="aq-wishlist-popup-remove"><i class="fa-regular fa-xmark"></i></span>
                <div class="aq-wishlist-popup-thumb  d-flex align-items-center">
                    <img src="{{ asset('assets/img/electronics/arrival-product/product-5/product-1.jpg') }}" alt="">
                    <div class="aq-wishlist-popup-thumb-info">
                        <h4 class="aq-wishlist-popup-title">iPhone 13 Pro max</h4>
                        <span class="aq-wishlist-popup-price">578.00</span>
                    </div>
    ...
    <div class="aq-wishlist-popup-bottom d-flex justify-content-between align-items-center">
        <a class="aq-line-anim" href="#">Open wishlist page</a>
        <a class="aq-line-anim" href="#">Continue shopping</a>
    </div>
    <div class="aq-wishlist-popup-text">
        <p><b>iPhone 13 Pro max</b> has been added to Wishlist.</p>
    </div>
</div>