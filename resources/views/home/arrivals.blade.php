                        ...
                        <div class="aq-product-thumb aq-img-hover-wrap p-relative mb-10">
                            @if($product->discount_price)
                                <div class="aq-product-badge">
                                    <span
                                        class="clr-sale">-{{ round((($product->price - $product->discount_price) / $product->price) * 100) }}%</span>
                                </div>
                            @endif
                            ...
                            <a href="{{ route('products.show', $product->slug) }}">
                                <img class="aq-product-img current-cached lazyloaded" src="{{ asset($product->image) }}"
                                    alt="{{ $product->name }}">
                            </a>
                        </div>
                        <div class="aq-product-content text-center">
                            <h4 class="aq-product-title mb-10"><a
                                    href="{{ route('products.show', $product->slug) }}">{{ $product->name }}</a></h4>
